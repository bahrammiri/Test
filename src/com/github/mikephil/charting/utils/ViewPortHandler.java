...
public class ViewPortHandler {
    ...
    public boolean isInBoundsY(float y, float height ) {
        if (isInBoundsTop(y) && isInBoundsBottom(y,height))
            return true;
        else
            return false;
    }
    ...
    public boolean isInBoundsBottom(float y, float height ) {
        y = (float)((int)(y * 100.f)) / 100.f + height;
        return mContentRect.bottom >= y ? true : false;
    }
