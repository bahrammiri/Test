...
public class XAxis extends AxisBase {
    ...
    /** the arrayList containing all guaranteed x-axis labels */
    protected List <String> mGuaranteedValues = new ArrayList<> (  );
    /**
    ...
    /**
     * Sets the labels for axis that should be guaranteed displayed;
     * @param values
     */
    public void setGuaranteedValues ( List < String > values ) { mGuaranteedValues = values; }

    /**
     * Get the labels for axis that should be guaranteed displayed;
     * @return
     */
    public List < String > getGuaranteedValues ( ) { return mGuaranteedValues; }
