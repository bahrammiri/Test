...
public abstract class ComponentBase {
    ...
    /**
     * sets the size of the label text in dp min = 6f, max = 24f, default
     * 10f
     * 
     * @param size
     */
  ...
  /**
     * sets the size of the label text in pixels min = 6f, max = 48f, default
     * 10f
     *
     * @param size
     */
    public void setTextSizeP (float size) {
