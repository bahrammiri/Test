...
public abstract class AxisBase extends ComponentBase {
    ...
    private int mLabelBackground = Color.TRANSPARENT;
    ...
    /** flag that indicates of the background of this axis should be drawn or not */
    protected boolean mDrawLabelsBackGround = false;
    ...
    /**
     *
     * Set this to true to enable drawing the background for labels;
     *
     * @param enabled
     */
    public void setDrawLabelsBackGround ( boolean enabled ) { mDrawLabelsBackGround = enabled; }
    /**
    ...
    /**
     * Returns true if the labels' background should be drawn.
     *
     * @return
     */
    public boolean isDrawLabelsBackGround () { return mDrawLabelsBackGround; }
    /**
    ...
    /**
     * Sets the color of the background for labels.
     *
     * @param color
     */
    public void setLabelBackgroundColor ( int color ) {
        mLabelBackground = color;
    }
    ...
    public int getLabelBackgroundColor () { return mLabelBackground; }
    /**
