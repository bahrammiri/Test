...
public class YAxis extends AxisBase {
    ...
    /** if true, the y-label entries will skip 1st value */
    protected boolean mSkipFirst = false;
    ...
    /** display custom data in OY  */
    protected boolean mCustomAxisValue = false;

    /** custom intervals */
    public float[] mCustomAxis = new float[] {};
    ...
    public float [] getCustomAxis () {
        return mCustomAxis;
    }

    public void setCustomAxis ( float [] data ) {
        mCustomAxis = data;
    }
    ...
    /**
     * Display custom array of data in axis;
     * @return
     */
    public boolean isCustomAxisValue () {
        return mCustomAxisValue;
    }

    /**
     * Display custom value for Y axis, see [{@link #setCustomAxis(float[])}]
     * @param enable
     */
    public void showCustomAxisValue ( boolean enable ) {
        mCustomAxisValue = enable;
    }
    /**
    ...
    /**
     * enable this to force skip first value of the y-axis labels
     * @param skip
     */
    public void setSkipFirst ( boolean skip ) { this.mSkipFirst = skip; }
    ...
    /**
     * return true if the chart is skip to display first value, false otherwise
     * @return
     */
    public boolean isSkipFirst () { return mSkipFirst; }
