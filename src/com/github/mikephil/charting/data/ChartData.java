...
public abstract class ChartData<T extends DataSet<? extends Entry>> {
    ...
    /** array that holds all DrawableSets the ChartData object represents */
    protected List<BitmapSet > mBitmapSets;


    public List <BitmapSet > getBitmapSets () {
      return mBitmapSets;
    }

    public void setBitmapSets ( List< BitmapSet > mBitmapSets ) {
      this.mBitmapSets = mBitmapSets;
    }

    public ChartData() {
        mXVals = new ArrayList<String>();
        mDataSets = new ArrayList<T>();
        mBitmapSets = new ArrayList<> ( );
    }
    ...
    public ChartData(List<String> xVals) {
        ...
        this.mBitmapSets = new ArrayList<> ( );
        init();
    }
