...
import com.github.mikephil.charting.listener.OnEntryDragListener;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleData<? extends BarLineScatterCandleDataSet<? extends Entry>>>
    ...
    /**
    * flag that indicates if highlighting enabled
    */
    ...
    /** the listener for user dragging the Entry */
    protected OnEntryDragListener mEntryDragListener;
    ...
    /** bitmap that will be drawn inside plot. */
  ...
  /**
   * this value needed for additional padding inside plot ( point always been inside plot drawable )
   */
    float mPointSize = 0.0f;

  /**
   * Set plot point size for ad. size of drawable inside plot.
   * @param size
   */
    ...
    public float getPointSize ( ) { return mPointSize; }
    ...
    protected void drawGridBackground(Canvas c) {
        ...
        if (mDrawGridBackground) {
          ...
          rectf = new RectF ( rectf.left - mPointSize, rectf.top - mPointSize, rectf.right + mPointSize, rectf.bottom + mPointSize );
...
//          d.draw ( c );
     ...
     * @param dragListener
     */
    public void setOnEntryDragListener ( OnEntryDragListener dragListener ) {
        this.mEntryDragListener = dragListener;
    }
    ...
    /**
     * Gets the OnEntryDragListener. May be null.
     *
     * @return
     */
    public OnEntryDragListener getEntryDragListener() {
        return mEntryDragListener;
    }
    ...
    /**
     * Set this to true to allow highlighting after click;
     */
  ...
  public Entry createEntryByTouch (float x, float y ) {
...
//    }
    ...
    if ( xTouchVal < 1 ) xTouchVal = 1;
    if ( xTouchVal > getXChartMax () - 1 ) xTouchVal = ( int )getXChartMax () - 1;

    if ( yTouchVal > getYChartMax () ) yTouchVal = getYChartMax ();
    if ( yTouchVal < getYChartMin ()) yTouchVal = getYChartMin ();
    return new Entry ( yTouchVal, (int)xTouchVal, true );
  }
    /**
