...
public class XAxisRenderer extends AxisRenderer {
    ...
    protected void drawLabels(Canvas c, float pos) {
        ...
        for (int i = mMinX; i <= mMaxX; i += 1 ) {
            // if that value guaranteed or this value is in step;
            if ( mXAxis.getGuaranteedValues ().contains ( mXAxis.getValues ().get ( i ) )
                    || i == mMinX
//                    || i % mXAxis.mAxisLabelModulus == 0
                    || i == mMaxX ) {
              position[0] = i;
